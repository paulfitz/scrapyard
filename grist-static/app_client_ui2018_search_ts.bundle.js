...
class FinderImpl {
  ...
  async init() {
    if (this._gristDoc.activeViewId.get() === "data") {
      const rawSections = this._gristDoc.docModel.visibleTables.peek().sort((a, b) => (0,app_common_gutil__WEBPACK_IMPORTED_MODULE_2__.nativeCompare)(a.tableNameDef.peek(), b.tableNameDef.peek())).map((t) => t.rawViewSection.peek()).filter((s) => Boolean(s.id.peek()));
...
class SearchModelImpl extends grainjs__WEBPACK_IMPORTED_MODULE_3__.Disposable {
  constructor(_gristDoc) {
    super();
    this._gristDoc = _gristDoc;
    this.value = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, "");
    this.isOpen = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, false);
    this.isRunning = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, false);
    this.noMatch = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, true);
    this.isEmpty = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, true);
    this.multiPage = grainjs__WEBPACK_IMPORTED_MODULE_3__.Observable.create(this, false);
    ...
    this.allLabel = grainjs__WEBPACK_IMPORTED_MODULE_3__.Computed.create(this, (use) => use(this._gristDoc.activeViewId) === "data" ? "Search all tables" : "Search all pages");
