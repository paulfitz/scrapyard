...
/* harmony export */ });
/* harmony import */ var app_common_gristUrls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! app/common/gristUrls */ "./app/common/gristUrls.ts");
...
/* harmony import */ var app_common_roles__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/common/roles */ "./app/common/roles.ts");
...
/* harmony import */ var app_client_lib_copyToClipboard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/client/lib/copyToClipboard */ "./app/client/lib/copyToClipboard.ts");
/* harmony import */ var app_client_lib_testState__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! app/client/lib/testState */ "./app/client/lib/testState.ts");
/* harmony import */ var app_client_lib_MultiUserManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/client/lib/MultiUserManager */ "./app/client/lib/MultiUserManager.ts");
/* harmony import */ var app_client_lib_ACUserManager__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/client/lib/ACUserManager */ "./app/client/lib/ACUserManager.ts");
/* harmony import */ var app_client_models_errors__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/client/models/errors */ "./app/client/models/errors.ts");
/* harmony import */ var app_client_models_gristUrlState__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! app/client/models/gristUrlState */ "./app/client/models/gristUrlState.ts");
/* harmony import */ var app_client_models_UserManagerModel__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! app/client/models/UserManagerModel */ "./app/client/models/UserManagerModel.ts");
/* harmony import */ var app_client_ui_GristTooltips__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! app/client/ui/GristTooltips */ "./app/client/ui/GristTooltips.ts");
/* harmony import */ var app_client_ui_shadowScroll__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! app/client/ui/shadowScroll */ "./app/client/ui/shadowScroll.ts");
/* harmony import */ var app_client_ui_tooltips__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! app/client/ui/tooltips */ "./app/client/ui/tooltips.ts");
/* harmony import */ var app_client_ui_UserImage__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! app/client/ui/UserImage */ "./app/client/ui/UserImage.ts");
/* harmony import */ var app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! app/client/ui/UserItem */ "./app/client/ui/UserItem.ts");
/* harmony import */ var app_client_ui2018_buttons__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! app/client/ui2018/buttons */ "./app/client/ui2018/buttons.ts");
/* harmony import */ var app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! app/client/ui2018/cssVars */ "./app/client/ui2018/cssVars.ts");
...
/* harmony import */ var app_client_ui2018_links__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! app/client/ui2018/links */ "./app/client/ui2018/links.ts");
/* harmony import */ var app_client_ui2018_loaders__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! app/client/ui2018/loaders */ "./app/client/ui2018/loaders.ts");
/* harmony import */ var app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! app/client/ui2018/menus */ "./app/client/ui2018/menus.ts");
/* harmony import */ var app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! app/client/ui2018/modals */ "./app/client/ui2018/modals.ts");
...
async function getModel(options) {
  ...
  return new app_client_models_UserManagerModel__WEBPACK_IMPORTED_MODULE_11__.UserManagerModelImpl(permissionData, options.resourceType, pick(options, ["activeUser", "reload", "appModel", "docPageModel", "resource"]));
}
function showUserManagerModal(userApi, options) {
  const modelObs = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.observable)(null);
  async function onConfirm(ctl) {
    ...
    const tryToSaveChanges = async () => {
      ...
      try {
        ...
        (0,app_client_models_errors__WEBPACK_IMPORTED_MODULE_9__.reportError)(err);
      }
    };
    if (model.isSelfRemoved.get()) {
      const name = resourceName(model.resourceType);
      (0,app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.confirmModal)(`You are about to remove your own access to this ${name}`, "Remove my access", tryToSaveChanges, `Once you have removed your own access, you will not be able to get it back without assistance from someone else with sufficient access to the ${name}.`);
    } else {
      tryToSaveChanges().catch(app_client_models_errors__WEBPACK_IMPORTED_MODULE_9__.reportError);
    }
  }
  const waitPromise = getModel(options).then((model) => modelObs.set(model)).catch(app_client_models_errors__WEBPACK_IMPORTED_MODULE_9__.reportError);
  (0,app_common_gutil__WEBPACK_IMPORTED_MODULE_1__.isLongerThan)(waitPromise, 400).then((slow) => slow && modelObs.set("slow")).catch(() => {
  });
  return buildUserManagerModal(modelObs, onConfirm, options);
}
function buildUserManagerModal(modelObs, onConfirm, options) {
  return (0,app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.modal)((ctl) => [
    { style: "padding: 0;" },
    options.showAnimation ? grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls(app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.cssAnimatedModal.className) : null,
    grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.domComputed(modelObs, (model) => {
      if (!model) {
        return null;
      }
      if (model === "slow") {
        return cssSpinner((0,app_client_ui2018_loaders__WEBPACK_IMPORTED_MODULE_21__.loadingSpinner)());
      }
      const cssBody = model.isPersonal ? cssAccessDetailsBody : cssUserManagerBody;
      return [
        cssTitle(renderTitle(options.resourceType, options.resource, model.isPersonal), options.resourceType === "document" && (!model.isPersonal || model.isPublicMember) ? makeCopyBtn(options.linkToCopy, cssCopyBtn.cls("-header")) : null, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-header")),
        (0,app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.cssModalBody)(cssBody(new UserManager(model, pick(options, "linkToCopy", "docPageModel", "appModel", "prompt", "resource")).buildDom())),
        (0,app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.cssModalButtons)({ style: "margin: 32px 64px; display: flex;" }, model.isPublicMember ? null : (0,app_client_ui2018_buttons__WEBPACK_IMPORTED_MODULE_17__.bigPrimaryButton)("Confirm", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.boolAttr("disabled", (use) => !use(model.isAnythingChanged)), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", () => onConfirm(ctl)), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-confirm")), (0,app_client_ui2018_buttons__WEBPACK_IMPORTED_MODULE_17__.bigBasicButton)(model.isPublicMember ? "Close" : "Cancel", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", () => ctl.close()), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-cancel")), model.resourceType === "document" && model.gristDoc && !model.isPersonal ? (0,app_client_ui_tooltips__WEBPACK_IMPORTED_MODULE_14__.withInfoTooltip)((0,app_client_ui2018_links__WEBPACK_IMPORTED_MODULE_20__.cssLink)({ href: (0,app_client_models_gristUrlState__WEBPACK_IMPORTED_MODULE_10__.urlState)().makeUrl({ docPage: "acl" }) }, grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.text((use) => use(model.isAnythingChanged) ? "Save & " : ""), "Open Access Rules", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", (ev) => {
          ev.preventDefault();
          return onConfirm(ctl).then(() => (0,app_client_models_gristUrlState__WEBPACK_IMPORTED_MODULE_10__.urlState)().pushUrl({ docPage: "acl" }));
        }), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-open-access-rules")), app_client_ui_GristTooltips__WEBPACK_IMPORTED_MODULE_12__.GristTooltips.openAccessRules(), { domArgs: [cssAccessLink.cls("")] }) : null, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-buttons"))
      ];
    })
  ]);
}
class UserManager extends grainjs__WEBPACK_IMPORTED_MODULE_3__.Disposable {
  ...
  buildDom() {
    ...
    return [
      ...
      this._dom = (0,app_client_ui_shadowScroll__WEBPACK_IMPORTED_MODULE_13__.shadowScroll)((0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-members"), this._buildPublicAccessMember(), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.forEach(this._model.membersEdited, (member) => this._buildMemberDom(member)))
    ];
  }
  ...
  _buildOptionsDom() {
    ...
    let tooltipControl;
    return (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("div", cssOptionRowMultiple((0,app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon)("AddUser"), cssLabel("Invite multiple"), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", (_ev) => (0,app_client_lib_MultiUserManager__WEBPACK_IMPORTED_MODULE_7__.buildMultiUserManagerModal)(this, this._model, (email, role) => {
      this._onAddOrEdit(email, role);
    }))), cssOptionRow(this._model.isOrg ? null : (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("span", { style: `float: left;` }, (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("span", "Inherit access: "), this._inheritRoleSelector()), publicMember ? (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("span", { style: `float: right;` }, cssSmallPublicMemberIcon("PublicFilled"), (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("span", "Public access: "), cssOptionBtn((0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menu)(() => {
      tooltipControl == null ? void 0 : tooltipControl.close();
      return [
        (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuItem)(() => publicMember.access.set(app_common_roles__WEBPACK_IMPORTED_MODULE_2__.VIEWER), "On", (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)(`um-public-option`)),
        (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuItem)(() => publicMember.access.set(null), "Off", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("disabled", (use) => use(publicMember.inheritedAccess) !== null), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)(`um-public-option`)),
        grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.maybe((use) => use(publicMember.inheritedAccess) !== null, () => (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuText)(`Public access inherited from ${(0,app_client_models_UserManagerModel__WEBPACK_IMPORTED_MODULE_11__.getResourceParent)(this._model.resourceType)}. To remove, set 'Inherit access' option to 'None'.`))
      ];
    }), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.text((use) => use(publicMember.effectiveAccess) ? "On" : "Off"), cssCollapseIcon("Collapse"), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-public-access")), (0,app_client_ui_tooltips__WEBPACK_IMPORTED_MODULE_14__.hoverTooltip)((ctl) => {
      tooltipControl = ctl;
      return "Allow anyone with the link to open.";
    })) : null));
  }
  _buildMemberDom(member) {
    const disableRemove = grainjs__WEBPACK_IMPORTED_MODULE_3__.Computed.create(null, (use) => this._model.isPersonal ? !member.origAccess : Boolean(this._model.isActiveUser(member) || use(member.inheritedAccess)));
    return (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("div", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.autoDispose(disableRemove), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.maybe((use) => use(member.effectiveAccess) && use(member.effectiveAccess) !== app_common_roles__WEBPACK_IMPORTED_MODULE_2__.GUEST, () => (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberListItem)(app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberListItem.cls("-removed", member.isRemoved), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberImage)((0,app_client_ui_UserImage__WEBPACK_IMPORTED_MODULE_15__.createUserImage)(getFullUser(member), "large")), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberText)((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberPrimary)(member.name || member.email, member.email ? grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("member-email") : null, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-name")), !member.name ? null : (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberSecondary)(member.email, grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("member-email"), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-email")), this._model.isPersonal ? this._buildSelfAnnotationDom(member) : this._buildAnnotationDom(member)), member.isRemoved ? null : this._memberRoleSelector(member.effectiveAccess, member.inheritedAccess, this._model.isActiveUser(member)), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberBtn)(member.isRemoved ? cssUndoIcon("Undo", (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-undo")) : (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssRemoveIcon)("Remove", (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-delete")), app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberBtn.cls("-disabled", disableRemove), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", () => disableRemove.get() || (member.isRemoved ? this._model.add(member.email, member.access.get()) : this._model.remove(member)))), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member"))));
  }
  _buildAnnotationDom(member) {
    return grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.domComputed(this._model.annotations, (annotations) => {
      const annotation = annotations.users.get(member.email);
      if (!annotation) {
        return null;
      }
      if (annotation.isSupport) {
        return (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberType)("Grist support");
      }
      if (annotation.isMember && annotations.hasTeam) {
        return (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberType)("Team member");
      }
      ...
      if (limit.at <= limit.top) {
        elements.push((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberType)(`${limit.at} of ${limit.top} ${collaborator}s`));
      } else {
        elements.push((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberTypeProblem)(`${(0,app_common_gutil__WEBPACK_IMPORTED_MODULE_1__.capitalizeFirstWord)(collaborator)} limit exceeded`));
      }
      if (annotations.hasTeam) {
        elements.push((0,app_client_ui2018_links__WEBPACK_IMPORTED_MODULE_20__.cssLink)({ href: (0,app_client_models_gristUrlState__WEBPACK_IMPORTED_MODULE_10__.urlState)().makeUrl({ manageUsers: true }) }, grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", (e) => {
          if (this._options.appModel) {
            e.preventDefault();
            manageTeam(this._options.appModel, () => this._model.reloadAnnotations(), { email: member.email }).catch(app_client_models_errors__WEBPACK_IMPORTED_MODULE_9__.reportError);
          }
        }), `Add ${member.name || "member"} to your team`));
      } else if (limit.at >= limit.top) {
        elements.push((0,app_client_ui2018_links__WEBPACK_IMPORTED_MODULE_20__.cssLink)({ href: app_common_gristUrls__WEBPACK_IMPORTED_MODULE_0__.commonUrls.plans, target: "_blank" }, "Create a team to share with more people"));
      }
      return elements;
    });
  }
  _buildSelfAnnotationDom(user) {
    return grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.domComputed(this._model.annotations, (annotations) => {
      ...
      return (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberType)(memberType, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-annotation"));
    });
  }
  _buildPublicAccessMember() {
    ...
    return (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("div", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.maybe((use) => Boolean(use(publicMember.effectiveAccess)), () => (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberListItem)(cssPublicMemberIcon("PublicFilled"), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberText)((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberPrimary)("Public Access"), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberSecondary)("Anyone with link ", makeCopyBtn(this._options.linkToCopy))), this._memberRoleSelector(publicMember.effectiveAccess, publicMember.inheritedAccess, false, this._model.publicUserSelectOptions), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberBtn)((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssRemoveIcon)("Remove", (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-delete")), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", () => publicMember.access.set(null))), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-public-member"))));
  }
  _buildSelfPublicAccessDom() {
    ...
    return (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("div", (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberListItem)(!activeUser ? cssPublicMemberIcon("PublicFilled") : (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberImage)((0,app_client_ui_UserImage__WEBPACK_IMPORTED_MODULE_15__.createUserImage)(activeUser, "large")), (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberText)((0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberPrimary)(name, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-name")), (activeUser == null ? void 0 : activeUser.email) ? (0,app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberSecondary)(activeUser.email) : null, cssMemberPublicAccess((0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("span", "Public access", (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-annotation")), cssPublicAccessIcon("PublicFilled"))), cssRoleBtn(accessLabel != null ? accessLabel : "Guest", cssCollapseIcon("Collapse"), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("disabled"), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-role")), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member")), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-members"));
  }
  _buildSelfAccessDom() {
    return (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.dom)("div", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.domComputed(this._model.membersEdited, (members) => members[0] ? this._buildMemberDom(members[0]) : null), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-members"));
  }
  _memberRoleSelector(role, inherited, isActiveUser, allRolesOverride) {
    ...
    return cssRoleBtn(this._model.isPersonal ? null : (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menu)(() => [
      grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.forEach(allRoles, (_role) => (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuItem)(() => isActiveUser || role.set(_role.value), _role.label, grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.text((use) => use(inherited) && use(inherited) === _role.value && !isActiveUser ? " (inherited)" : ""), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("disabled", (use) => app_common_roles__WEBPACK_IMPORTED_MODULE_2__.getStrongestRole(_role.value, use(inherited)) !== _role.value), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)(`um-role-option`))),
      isActiveUser ? (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuText)(`User may not modify their own access.`) : null,
      grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.maybe((use) => use(inherited) && !isActiveUser, () => (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuText)(`User inherits permissions from ${(0,app_client_models_UserManagerModel__WEBPACK_IMPORTED_MODULE_11__.getResourceParent)(this._model.resourceType)}. To remove, set 'Inherit access' option to 'None'.`)),
      grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.maybe((use) => !this._model.isOrg && use(role) === app_common_roles__WEBPACK_IMPORTED_MODULE_2__.GUEST, () => (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuText)(`User has view access to ${this._model.resourceType} resulting from manually-set access to resources inside. If removed here, this user will lose access to resources inside.`)),
      this._model.isOrg ? (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuText)(`No default access allows access to be granted to individual documents or workspaces, rather than the full team site.`) : null
    ]), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.text((use) => {
      const activeRole = allRoles.find((_role) => use(role) === _role.value);
      return activeRole ? activeRole.label : "Guest";
    }), cssCollapseIcon("Collapse"), this._model.isPersonal ? grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.cls("disabled") : null, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-role"));
  }
  _inheritRoleSelector() {
    const role = this._model.maxInheritedRole;
    const allRoles = this._model.inheritSelectOptions;
    return cssOptionBtn((0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menu)(() => [
      grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.forEach(allRoles, (_role) => (0,app_client_ui2018_menus__WEBPACK_IMPORTED_MODULE_22__.menuItem)(() => role.set(_role.value), _role.label, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)(`um-role-option`)))
    ]), grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.text((use) => {
      const activeRole = allRoles.find((_role) => use(role) === _role.value);
      return activeRole ? activeRole.label : "";
    }), cssCollapseIcon("Collapse"), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-max-inherited-role"));
  }
}
function getUserItem(member) {
  return {
    value: member.email,
    label: member.email,
    cleanText: (0,app_client_lib_ACIndex__WEBPACK_IMPORTED_MODULE_4__.normalizeText)(member.email),
    email: member.email,
    name: member.name,
...
class ACMemberEmail extends grainjs__WEBPACK_IMPORTED_MODULE_3__.Disposable {
  constructor(_onAdd, _members, _prompt) {
    super();
    this._onAdd = _onAdd;
    this._members = _members;
    this._prompt = _prompt;
    this._email = this.autoDispose((0,grainjs__WEBPACK_IMPORTED_MODULE_3__.observable)(""));
    if (_prompt) {
  ...
  buildDom() {
    ...
    const acIndex = new app_client_lib_ACIndex__WEBPACK_IMPORTED_MODULE_4__.ACIndexImpl(acUserItem);
    return (0,app_client_lib_ACUserManager__WEBPACK_IMPORTED_MODULE_8__.buildACMemberEmail)(this, {
      acIndex,
      emailObs: this._email,
      save: this._handleSave.bind(this),
      prompt: this._prompt
    }, (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-member-new"));
  }
  _handleSave(selectedEmail) {
    this._onAdd(selectedEmail, app_common_roles__WEBPACK_IMPORTED_MODULE_2__.VIEWER);
  }
}
...
function makeCopyBtn(linkToCopy, ...domArgs) {
  return linkToCopy && cssCopyBtn(cssCopyIcon("Copy"), "Copy Link", grainjs__WEBPACK_IMPORTED_MODULE_3__.dom.on("click", (ev, elem) => copyLink(elem, linkToCopy)), (0,app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.testId)("um-copy-link"), ...domArgs);
}
async function copyLink(elem, link) {
  await (0,app_client_lib_copyToClipboard__WEBPACK_IMPORTED_MODULE_5__.copyToClipboard)(link);
  (0,app_client_lib_testState__WEBPACK_IMPORTED_MODULE_6__.setTestState)({ clipboard: link });
  (0,app_client_ui_tooltips__WEBPACK_IMPORTED_MODULE_14__.showTransientTooltip)(elem, "Link copied to clipboard", { key: "copy-doc-link" });
}
async function manageTeam(appModel, onSave, prompt) {
  await (0,app_client_models_gristUrlState__WEBPACK_IMPORTED_MODULE_10__.urlState)().pushUrl({ manageUsers: false });
...
const cssAccessDetailsBody = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  display: flex;
  flex-direction: column;
  width: 600px;
  font-size: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.vars.mediumFontSize};
`);
const cssUserManagerBody = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(cssAccessDetailsBody, `
  height: 374px;
  border-bottom: 1px solid ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.modalBorderDark};
`);
const cssSpinner = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  display: flex;
  align-items: center;
  justify-content: center;
  margin: 32px;
`);
const cssCopyBtn = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_buttons__WEBPACK_IMPORTED_MODULE_17__.basicButton, `
  border: none;
  font-weight: normal;
  padding: 0 8px;
  &-header {
...
`);
const cssCopyIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon, `
  margin-right: 4px;
  margin-top: -2px;
`);
const cssOptionRow = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  font-size: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.vars.mediumFontSize};
  margin: 0 63px 23px 63px;
`);
const cssOptionRowMultiple = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  margin: 0 63px 12px 63px;
  font-size: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.vars.mediumFontSize};
  display: flex;
  cursor: pointer;
  color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlFg};
  --icon-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlFg};

  &:hover {
    color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlHoverFg};
    --icon-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlHoverFg};
  }
`);
const cssLabel = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("span", `
  margin-left: 4px;
`);
const cssOptionBtn = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("span", `
  display: inline-flex;
  font-size: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.vars.mediumFontSize};
  color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlFg};
  cursor: pointer;
`);
const cssPublicMemberIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon, `
  width: 40px;
  height: 40px;
  margin: 0 4px;
  --icon-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.accentIcon};
`);
const cssSmallPublicMemberIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(cssPublicMemberIcon, `
  width: 16px;
  height: 16px;
  top: -2px;
`);
const cssPublicAccessIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon, `
  --icon-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.accentIcon};
`);
const cssUndoIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon, `
  --icon-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlSecondaryFg};
  margin: 12px 0;
`);
const cssRoleBtn = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  display: flex;
...
`);
const cssCollapseIcon = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_icons__WEBPACK_IMPORTED_MODULE_19__.icon, `
  margin-top: 1px;
  background-color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.controlFg};
`);
const cssAccessLink = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_links__WEBPACK_IMPORTED_MODULE_20__.cssLink, `
  align-self: center;
  margin-left: auto;
`);
const cssOrgName = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("div", `
  font-size: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.vars.largeFontSize};
`);
const cssOrgDomain = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)("span", `
  color: ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.theme.accentText};
`);
const cssTitle = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui2018_modals__WEBPACK_IMPORTED_MODULE_23__.cssModalTitle, `
  margin: 40px 64px 0 64px;

  @media ${app_client_ui2018_cssVars__WEBPACK_IMPORTED_MODULE_18__.mediaXSmall} {
    & {
      margin: 16px;
    }
  }
`);
const cssMemberPublicAccess = (0,grainjs__WEBPACK_IMPORTED_MODULE_3__.styled)(app_client_ui_UserItem__WEBPACK_IMPORTED_MODULE_16__.cssMemberSecondary, `
  display: flex;
  align-items: center;
  gap: 8px;
`);
function renderTitle(resourceType, resource, personal) {
  switch (resourceType) {
    case "organization": {
      if (personal) {
        return "Your role for this team site";
      }
      return [
